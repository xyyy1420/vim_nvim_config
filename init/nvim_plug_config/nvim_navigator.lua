require'navigator'.setup({
    -- log output, set to true and log path: ~/.cache/nvim/gh.log
  debug = false,
...
--  -- The attach code will apply to all LSP clients
  ...
  ts_fold = true,
    -- set to false if you will remap every key or if you using old version of nvim-
 ...
 -- treesitter variable context
  treesitter_analysis = true,
 -- bool|table false: use lsp to navigate between symbol ']r/[r', table: a list of
  treesitter_navigation = true,

  --lang using TS navigation
  -- -- how many items to run treesitter analysis
  treesitter_analysis_max_num = 100,
    -- condense form for treesitter analysis
  treesitter_analysis_condense = true,
  -- this value prevent slow in large projects, e.g. found 100000 reference in a project
  -- -- 0 ~ 100 blur the main window, 100: fully transparent, 0: opaque,  set to nil or 100 to disable it
  transparency = 50,
 ...
 -- if you would like to hook ray-x/lsp_signature plugin in navigator
  ...
  icons = {
    -- Code action
    code_action_icon = "A", -- note: need terminal support, for those not support unicode, might crash
    -- Diagnostics
    diagnostic_head = 'D',
    diagnostic_head_severity_1 = "S1",
    -- refer to lua/navigator.lua for more icons setups
  },

    -- set to true if you would like use the lsp installed by williamboman/mason
  mason = true,
